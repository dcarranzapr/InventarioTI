...
class GerenciaController extends Controller {
    ...
    public function accessRules() {
        ...
        return array(
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('index', 'view', 'create', 'update', 'Listarnombregerencia', 'admin'),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Gerencia'])) {
            $model->attributes = $this->convertLetters($_POST['Gerencia']);
            if ($model->save())
    ...
    public function actionIndex() {
        $model = new Gerencia('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Gerencia']))
            $model->attributes = $_GET['Gerencia'];
    ...
    public function actionListarnombregerencia() {
        if (isset($_GET['term'])) {
    ...
    public function loadModel($id) {
        $model = Gerencia::model()->findByPk($id);
        if ($model === null)
     ...
     * @param Gerencia $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'gerencia-form') {
