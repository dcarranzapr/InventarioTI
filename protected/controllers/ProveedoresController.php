...
class ProveedoresController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('index', 'view', 'create', 'update', 'delete', 'Listarnombreproveedor'),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Proveedores'])) {
            $model->attributes = $this->convertLetters($_POST['Proveedores']);
            if ($model->save())
    ...
    public function actionListarnombreproveedor() {
        if (isset($_GET['term'])) {

            $criteria = new CDbCriteria;

            $criteria->condition = "nombreProveedor like '%" . $_GET['term'] . "%'";


            $proveedores = Proveedores::model()->findAll($criteria);
            $return_array = array();
