...
class MarcaController extends Controller {
    ...
    public function accessRules() {
        return array(
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('index', 'view', 'create', 'update', 'delete', 'Listarnombremarcas'),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Marca'])) {
            $model->attributes = $this->convertLetters($_POST['Marca']);
            if ($model->save())
    ...
    public function actionListarnombremarcas() {
        if (isset($_GET['term'])) {

            $criteria = new CDbCriteria;

            $criteria->condition = "nombremarca like '%" . $_GET['term'] . "%'";
