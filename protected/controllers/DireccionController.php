...
class DireccionController extends Controller {
    ...
    public function accessRules() {
        ...
        return array(
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update', 'create', 'Listarnombredireccion', 'admin', 'index'),
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Direccion'])) {
            ...
            $model->attributes = $this->convertLetters($_POST['Direccion']);
            if ($model->save())
    ...
    public function actionListarnombredireccion() {
        if (isset($_GET['term'])) {

            $criteria = new CDbCriteria;

            $criteria->condition = "nombredireccion like '%" . $_GET['term'] . "%'";


            $direcciones = Direccion::model()->findAll($criteria);
            $return_array = array();
