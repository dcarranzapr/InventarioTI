...
class Estatus extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'equipogenerals' => array(self::HAS_MANY, 'Equipogeneral', 'idEstatus'),
            'equipogeneralLogs' => array(self::HAS_MANY, 'EquipogeneralLog', 'idEstatus'),
            'prestamoses' => array(self::HAS_MANY, 'Prestamos', 'estatus_idEstatus'),
        );
    }
