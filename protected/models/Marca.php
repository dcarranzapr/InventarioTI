...
class Marca extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('nombremarca', 'length', 'max' => 50),
            array('descripcion', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('idMarca, nombremarca, descripcion', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'equipogenerals' => array(self::HAS_MANY, 'Equipogeneral', 'idMarca'),
            'equipogeneralLogs' => array(self::HAS_MANY, 'EquipogeneralLog', 'idMarca'),
            'modelos' => array(self::HAS_MANY, 'Modelo', 'fkidMarca'),
        );
    }
