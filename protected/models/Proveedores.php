...
class Proveedores extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('nombreProveedor', 'required'),
            array('nombreProveedor', 'length', 'max' => 40),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('idProveedores, nombreProveedor', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'equipogenerals' => array(self::HAS_MANY, 'Equipogeneral', 'idProveedores'),
            'equipogeneralLogs' => array(self::HAS_MANY, 'EquipogeneralLog', 'idProveedores'),
        );
    }
