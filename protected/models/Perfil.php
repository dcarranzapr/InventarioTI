...
class Perfil extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('id_perfil, nombreperfil', 'required'),
            array('id_perfil', 'numerical', 'integerOnly' => true),
            array('nombreperfil', 'length', 'max' => 30),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id_auto, id_perfil, nombreperfil', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        ...
        return array(
            'personases' => array(self::HAS_MANY, 'Personas', 'tipo'),
        );
    }
