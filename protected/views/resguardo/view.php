...
$this->menu = array(
    ...
    array('label' => 'Modificar resguardo', 'url' => array('update', 'id' => $model->id_resguardo)),
    array('label' => 'Control de resguardo', 'url' => array('index')),
);
?>

<h1>Resguardo de <?php echo $model->idColaboradorEmpleado0->usuarioNombre; ?></h1>
...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        'nombreEquipo',
        'capturaUser',
        'idColaboradorEmpleado0.usuarioNombre',
    ),
));
?>
...
/** End Widget * */
echo CHtml::imageButton(Yii::app()->baseUrl . '/images/resguardo.jpg', array('style' => 'margin-right:50px;float:right; width:30px;',
    'title' => 'Agregar equipo',
    'onclick' => '$("#dialog-animation").dialog("open"); return false;',
));
$imghtml = CHtml::image(Yii::app()->baseUrl . '/images/iconos/printer.png');
echo CHtml::link($imghtml, array('imprimir', 'id' => $model->id_resguardo), array("style" => "margin-right:5px;margin-top:5px;float:right; width:30px;"));
?>
