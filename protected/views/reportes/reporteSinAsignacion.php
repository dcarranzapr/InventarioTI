...
<h1>Reporte de equipo sin asignación</h1>
</br>
<div class="row-fluid">
<?php echo CHtml::beginForm(Yii::app()->createUrl('/reportes/reporteSinAsignacionResults'), 'POST', array(
    'id'=>'form-search',
...
<br />
<?php echo CHtml::link('<i class="icon-download-alt icon-white"></i> Generar Excel', array('/reportes/general'), array('target' => '_blank', 'class' => 'btn btn-primary','id'=>"downloadExcel")); ?>
