...
<div class="row-fluid">
<?php echo CHtml::beginForm(Yii::app()->createUrl('/reportes/prestamoResults'), 'POST', array(
    'id'=>'form-search',
...
<br />
<?php echo CHtml::link('<i class="icon-download-alt icon-white"></i> Generar Excel', array('/reportes/prestamo'), array('target' => '_blank', 'class' => 'btn btn-primary','id'=>"downloadExcel")); ?>
